/**
 * Created by tvspina on 1/12/17.
 */

// #D83D66 works well for 3D border
// Diverging colormap for 256 classes from http://stackoverflow.com/questions/33295120/how-to-generate-gif-256-colors-palette/33295456#33295456
function ColorMap1024()
{
    this.colormap =
        [
            "#16903E", "#FFFF00", "#1CE6FF", "#FF34FF", "#FF4A46", "#008941", "#006FA6", "#A30059",
            ...
            "#061203", "#DFFB71", "#868E7E", "#98D058", "#6C8F7D", "#D7BFC2", "#3C3E6E", "#083D66",
            ...
            "#3D7397", "#CAE8CE", "#D60034", "#AA6746", "#9E5585", "#BA6200", "#AAFF22", "#7FFFD4"
        ];
}

ColorMap1024.prototype.getColor = function (lb) {
    return this.colormap[iftSafeMod(lb, this.colormap.length)];
};

// Binary colormap to show only the main cell and its neighbors
function ColorMapBin() {
    this.colormap = ["#FFFF00", "#0000FF"];
}

ColorMapBin.prototype.getForegroundColor = function(lb) {
    return this.colormap[0];
};

ColorMapBin.prototype.getBackgroundColor = function() {
    return this.colormap[1];
};

ColorMapBin.prototype.getColor = function(lb) {
    if(lb !== 0) {
        return this.colormap[1];
    } else {
        return this.colormap[0];
...
// Binary colormap to show only the main cell and its neighbors
function ColorMapScribblesBin() {
    this.colormap = ["#BB00BB", "#FFE11F"];
}

ColorMapScribblesBin.prototype.getColor = function(lb) {
    if(lb !== 0) {
        return this.colormap[1];
    } else {
        return this.colormap[0];
...
// Function from http://stackoverflow.com/questions/5623838/rgb-to-hex-and-hex-to-rgb
...
function hexColormapToRgb(hexColormap) {
    var rgbColormap = [];

    for(var i = 0; i < hexColormap.length; i++) {
        var c = hexToRgb(hexColormap[i]);

        rgbColormap.push(new THREE.Vector3(c.r, c.g, c.b));
    }
